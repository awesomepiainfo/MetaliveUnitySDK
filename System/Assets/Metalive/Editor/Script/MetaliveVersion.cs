...
namespace MetaliveEditor
{
    public class MetaliveVersion : EditorWindow
    {
        ...
        private void Init(string profileName)
        {
            ...
            var profilePath = $"https://metalive-asset-resouse.s3.ap-northeast-2.amazonaws.com/admin/asset-resouse/WORLD/{MetaliveData.setting.project.bundleIndentifier}/{MetaliveData.setting.project.code}/v{profileName}";
